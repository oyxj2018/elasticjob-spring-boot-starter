...
import io.dreamstudio.elasticjob.autoconfigure.properties.JobEventRdbProperties;
...
@EnableConfigurationProperties(JobEventRdbProperties.class)
public class JobAutoConfiguration {
    ...
    @Autowired
    private JobEventRdbProperties jobEventRdbProperties;
    ...
    private void initElasticJobBean(String beanName, Object bean) throws BeansException {
        ...
        if(jobEventRdbProperties.isEnable()){
            BasicDataSource dataSource = new BasicDataSource();
            dataSource.setDriverClassName(jobEventRdbProperties.getDriverClassName());
            dataSource.setUrl(jobEventRdbProperties.getUrl());
            dataSource.setUsername(jobEventRdbProperties.getUsername());
            dataSource.setPassword(jobEventRdbProperties.getPassword());
            factory.addConstructorArgValue(new JobEventRdbConfiguration(dataSource));
        }
